...
} from "../utils/validateCustomerDraft"
    ...
    return (
        ...
        >
            ...
            <div className="form-field">
                <label htmlFor="edit-customer-full-name">
                    Full name
                </label>
