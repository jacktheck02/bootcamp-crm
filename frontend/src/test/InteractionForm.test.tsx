...
describe("InteractionForm", () => {
  it("renders the interaction fields", () => {
    render(
      <InteractionForm saving={false} onCancel={vi.fn()} onSaved={vi.fn()} />,
    );
  ...
  it("requires a summary", async () => {
    ...
    render(
      <InteractionForm saving={false} onCancel={vi.fn()} onSaved={onSaved} />,
    );
  ...
  it("creates an interaction", async () => {
    ...
    await user.type(screen.getByLabelText("Summary"), "Sent follow-up email.");
  ...
  it("can be cancelled", async () => {
    ...
    render(
      <InteractionForm saving={false} onCancel={onCancel} onSaved={vi.fn()} />,
    );
